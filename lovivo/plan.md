...
Agregar: AppliedRule, Bundle, BundleItem, PriceRule
Agregar applied_rules al interface Order
PENDIENTE: usuario enviará contenido del archivo
...
IndexUI: sección de bundles
ProductCard: PriceRuleBadge
CartSidebar: render bundle items
CartAdapter: exportar addBundle
