        ...
        <div className="flex items-center gap-4 md:gap-8">
            ...
            <SheetContent side="left" className="w-[300px] sm:w-[400px]">
              ...
              <nav className="flex flex-col gap-4 mt-8">
                ...
                <Link 
                  to="/personalizados" 
                  onClick={() => setMobileMenuOpen(false)}
                  className="font-body text-lg text-primary font-semibold hover:text-primary py-3 border-b border-border"
                >
                  Personalízalo
                </Link>
                <Link 
          ...
          <nav className="hidden md:flex items-center gap-1">
            {[
              ...
              { to: '/personalizados', label: 'Personalízalo' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 pt-8 border-t border-secondary-foreground/20 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-sm text-sm font-semibold transition-opacity hover:opacity-80"
            style={{ background: 'rgba(255,255,255,0.12)', color: 'rgba(255,255,255,0.92)', border: '1px solid rgba(255,255,255,0.2)' }}
          >
    ...
    <>
      ...
      {showWhatsApp && (
        <FloatingWhatsApp 
          ...
          showTooltip={true}
          hideOnMobile={isProductPage || isBundlePage}
        />
      )}
    </>
  )
