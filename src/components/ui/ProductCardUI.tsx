        ...
        >
          <CardContent className="p-0 relative">
            ...
            <div className={`bg-muted overflow-hidden relative ${aspectRatioClass}`}>
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-background/90 via-background/70 to-background/20 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-all duration-500 flex flex-col justify-between p-6 translate-y-4 group-hover:translate-y-0">
